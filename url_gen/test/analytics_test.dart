...
void main() {
  group('Analytics Tests', () {
    test('Should successfully generate analytics string', () {
      var analytics = Analytics.fromParameters('R', '1.24.0', '12.0', 'Z', '17.0')
          .generateAnalyticsString();
      cldAssert('CARAlhAMZAR0', analytics);
    });
    test('Should successfully generate analytics string', () {
      var analytics =
          Analytics.fromParameters('R', '1.24.0-beta.6', '12.0', 'Z', '17.0')
              .generateAnalyticsString();
      cldAssert('CARAlhAMZAR0', analytics);
    });
    test(
        ...
        () {
      var analytics = Analytics.fromParameters('R', '1.24.0', '12.0.1', 'Z', '17.0')
          .generateAnalyticsString();
      cldAssert('CARAlhAMZAR0', analytics);
    });
    test('Test successfully generate analytics token with misbehaved version string', () {
            var analytics = Analytics.fromParameters('R', '1.24.0', '12.0.1', 'Z', 'sdk_gphone64_arm64-userdebug 13 TE1A.220922.031 10278734 dev-keys')
                .generateAnalyticsString();
