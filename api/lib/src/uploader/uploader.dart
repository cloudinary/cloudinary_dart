import 'package:cloudinary_api/src/models/uploader_request.dart';
import 'package:cloudinary_api/src/uploader/uploader_response.dart';
import 'package:cloudinary_api/src/uploader/uploader_utils.dart';
...
class Uploader {
  ...
  Future<UploaderResponse<UploadResult>>? upload(
    ...
    UploadRequest request = UploadRequest(params ?? UploadParams(), payload,
  ...
  Future<UploaderResponse<UploadResult>> rename(
    ...
    return _uploaderUtils.callApi<UploadResult>(request, 'rename',
        options: params, fromJson: UploadResult.fromJson);
  }

  Future<UploaderResponse<UploadResult>> explicit(ExplicitParams params) {
    UploaderRequest request = UploaderRequest(params);
    return _uploaderUtils.callApi<UploadResult>(request, 'explicit',
        options: params, fromJson: UploadResult.fromJson);
  }

  Future<UploaderResponse<UploadResult>> downloadBackedupAsset(
      DownloadBackupAssetParams params) {
    UploaderRequest request = UploaderRequest(params);
    return _uploaderUtils.callApi<UploadResult>(request, 'download_backup',
        options: params, fromJson: UploadResult.fromJson);
  }

  Future<UploaderResponse<UploadResult>> destroy(DestroyParams params) {
    UploaderRequest request = UploaderRequest(params);
    return _uploaderUtils.callApi<UploadResult>(request, 'destroy',
        options: params, fromJson: UploadResult.fromJson);
  }
  ...
  Future<UploaderResponse<ContextResult>> addContext(AddContextParams params) {
    ...
    UploaderRequest request = UploaderRequest(params);
    return _uploaderUtils.callApi<ContextResult>(request, 'context',
        options: params, fromJson: ContextResult.fromJson);
  }

  Future<UploaderResponse<ContextResult>> removeAllContext(
      RemoveAllContextParams params) {
