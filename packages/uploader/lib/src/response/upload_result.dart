...
class ResultEager {
  ...
  ResultEager({this.transformation, this.width, this.height, this.bytes, this.format, this.url, this.secureUrl});
}
...
class ResultAccessibilityAnalysis {
  ...
  ResultAccessibilityAnalysis(this.colorblindAccessibilityAnalysis, this.colorblindAccessibilityScore);
}
...
class ResultColorblindAccessibilityScore {
  ...
  ResultColorblindAccessibilityScore(this.distinctEdges, this.distinctColors, this.mostIndistinctPair);
}