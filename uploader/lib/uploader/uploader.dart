...
class Uploader {
  ...
  NetworkRequest prepareNetworkRequest(
      String action, UploadRequest request, String adapter) {
  ...
  CldMultipartRequest uploadLargeParts(
    ...
    for (int index = 0; index < chunkCount; index++) {
      ...
      multiRequest = networkDelegate.uploadLarge(
          stream,
          prepareNetworkRequest('upload', request, ''),
          startOffset,
          endOffset,
          payload.length);
    }
  ...
  bool requireSigning(
      String action, UploadParams params, UploadRequest request) {
    var missingSignature = (params.signature != null) ? false : true;
    var signedRequest =
        ((request.params.unsigned != null) ? !request.params.unsigned! : false);
